...
const PDFStockTransfer = ({statusExport,anExport,detailExport,accountCreate}) =>{
    Font.register({
        family: "Roboto",
        src:
    ...
    const SupplierInfo = ({exports,accountCreate}) => (
    ...
    const InvoiceItemsTable = ({detailExport}) => (
