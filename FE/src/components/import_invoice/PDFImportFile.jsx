...
const PDFImportFile = ({invoice,createDate,importDate,fullName,phoneNumber}) =>{
    Font.register({
        family: "Roboto",
        src:
    ...
    const SupplierInfo = ({invoice,phoneNumber,fullName}) => (
    ...
    const InvoiceNo = ({invoice,createDate,importDate}) => (
        <Fragment>
