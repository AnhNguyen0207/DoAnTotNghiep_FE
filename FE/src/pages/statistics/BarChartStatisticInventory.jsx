...
const BarChartStatisticInventory = (props) => {
  ...
  let dataChart = props.inventoryStatistic.filter((item) => {
    var res = {
  ...
  const [data, setData] = useState(dataChart.slice(0, 10));
    ...
    <div>
      ...
      <div>
        <Row>
          <Col span={12}>
            <Checkbox
              defaultChecked={visible.quantity}
              onChange={(e) => {
