...
const ReturnInvoiceImport = ({ returnInvoice, invoice }) => {
  return (
    <>
        ...
        >
          ...
          >
            ...
            {invoice.anImport.isImport && (
              <>
                <Link
                  to={`/coordinator/purchase_orders/return/${invoice.anImport.code}`}
                >
                  <Button
                    type={"primary"}
                  ...
                  {returnInvoice.reverse().map((obj, index) => (
                    ...
                    >
                      <PDFDownloadLink
                        fileName={
                          "phieuTraHang - " +
                          moment(obj.createDate).format("DD/MM/YYYY HH:mm:ss") +
                          ".pdf"
                        }
                        document={
                          <PDFReturnImportInvoice
                            invoice={invoice}
                            returnInvoice={obj}
                          />
                        }
